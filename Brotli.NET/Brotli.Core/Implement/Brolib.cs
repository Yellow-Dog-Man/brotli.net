...
namespace Brotli
{
    public class Brolib
    {
        public static bool UseNewFlow = true;
        ...
        {
            if (UseNewFlow)
                return BrolibNew.BrotliDecoderCreateInstance(IntPtr.Zero, IntPtr.Zero, IntPtr.Zero);
        ...
        {
            if (UseNewFlow)
                return BrolibNew.BrotliEncoderSetParameter(state, parameter, value);
            if (UseX86)
            {
        ...
        {
            if (UseNewFlow)
                return BrolibNew.BrotliEncoderIsFinished(state);
            if (UseX86)
            {
        ...
        {
            if (UseNewFlow)
                BrolibNew.BrotliEncoderDestroyInstance(state);
            if (UseX86)
            {
        ...
        {
            if (UseNewFlow)
                return BrolibNew.BrotliEncoderVersion();
            if (UseX86)
            {
        ...
        {
            if (UseNewFlow)
                return BrolibNew.BrotliDecoderTakeOutput(state, ref size);
            if (UseX86)
            {
        ...
        {
            if (UseNewFlow)
                return BrolibNew.BrotliDecoderSetParameter(state, param, value);
        ...
        {
            if (UseNewFlow)
                return BrolibNew.BrotliDecoderDecompressStream(state, ref availableIn, ref nextIn, ref availableOut, ref nextOut, out totalOut);
        ...
        {
            if (UseNewFlow)
                return BrolibNew.BrotliDecoderVersion();
            if (UseX86)
            {
        ...
        {
            if (UseNewFlow)
                return BrolibNew.BrotliDecoderIsUsed(state);
            if (UseX86)
            {
        ...
        {
            if (UseNewFlow)
                return BrolibNew.BrotliDecoderIsFinished(state);
            if (UseX86)
            {
        ...
        {
            if (UseNewFlow)
                return BrolibNew.BrotliDecoderGetErrorCode(state);
            if (UseX86)
            {
        ...
        public static String BrotliDecoderErrorString(Int32 code)
        {
            IntPtr r = IntPtr.Zero;
            if (UseNewFlow)
                r = BrolibNew.BrotliDecoderErrorString(code);
            else
            {
                if (UseX86)
